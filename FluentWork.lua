...
------Bypass TP 2
 function GetIsLand(...)
    ...
    if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health == 0 then
        ...
        repeat wait(_G.FastAttackDelay) until game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health > 0; wait(0.2)
    end
    local tweenfunc = {}
        ...
        if Distance > 3000 and not AutoNextIsland and not (game.Players.LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game.Players.LocalPlayer.Character:FindFirstChild("Special Microchip") or game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game.Players.LocalPlayer.Character:FindFirstChild("Hallow Essence") or game.Players.LocalPlayer.Character:FindFirstChild("Sweet Chalice") or game.Players.LocalPlayer.Backpack:FindFirstChild("Sweet Chalice")) and not (Name == "Fishman Commando" or Name == "Fishman Warrior") then
            pcall(function()
                ...
                elseif game:GetService("Players")["LocalPlayer"].Data:FindFirstChild("LastSpawnPoint").Value == tostring(GetIsLand(RealTarget)) then
                    ...
                    wait(0.1)
                    repeat wait(_G.FastAttackDelay) until game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid").Health > 0
                else
...
function toTargetP(CFgo)
	if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health <= 0 or not game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid") then tween:Cancel() repeat wait(_G.FastAttackDelay) until game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid") and game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid").Health > 0 wait(7) return end
...
ImageButton.Image = "http://www.roblox.com/asset/?id=9614132122"
...
local listfastattack = {'Normal','Slow','Super'}
    ...
    _G.FastAttackDelay_Mode = Value
	if _G.FastAttackDelay_Mode == "Slow" then
		_G.FastAttackDelay = 0.175
	elseif _G.FastAttackDelay_Mode == "Normal" then
		_G.FastAttackDelay = 0.16
	elseif _G.FastAttackDelay_Mode == "Extra" then
...
if Third_Sea then
local MiscFarm = Tabs.Main:AddSection("Quest")

local ToggleQuest = Tabs.Main:AddToggle("ToggleBone", {
    Title = "Auto Quest",
    Description = "", 
    Default = false })
...
Options.ToggleBone:SetValue(false)
   local BoneCFrame2 = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    spawn(function()
        while wait() do 
            if _G.AutoBone then
                pcall(function()
